...
public class ConsolaOlimpicos
{
	...
	private void ejecutarAtletaNombre()
	{
		System.out.println("\n" + "Atleta por su nombre" + "\n");
		String atleta = input("Por favor ingrese el nombre de un atleta");
		Pais pais = calculadora.AtletaNombre(atleta);
		System.out.println("\nEl pais del atleta '" + atleta +  "', es " + pais.darNombre());
	}
	/**
